...
In order to answer our questions, a analysis shows we should be using the variable Behavior, size, roll. This is important as it guides us to show how we answer the questions.

# Methods for presence vs absence of odor

The methods we use for these problems involve explaining the categroical variables (Behavior, roll). We will use barchart as our graphical tool, favstats as our numerical tool, and t-tests as our inferential methods. To deal with the question about  presence of odor change the expected outcome, we will use this definition:
